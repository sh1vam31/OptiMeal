  ...
  return (
    <div className="space-y-16 max-w-5xl mx-auto py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-6 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/10 text-center space-y-1">
          <span className="text-3xl font-black text-gray-900 dark:text-white font-mono block">14,512</span>
          <span className="text-xs text-gray-600 dark:text-gray-400 uppercase font-mono tracking-wider block">Food Catalog Size</span>
        </div>
        <div className="p-6 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/10 text-center space-y-1">
          <span className="text-3xl font-black text-emerald-400 font-mono block">2-Stage</span>
          <span className="text-xs text-gray-600 dark:text-gray-400 uppercase font-mono tracking-wider block">Candidate + ML Pipeline</span>
        </div>
        <div className="p-6 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/10 text-center space-y-1">
          <span className="text-3xl font-black text-amber-400 font-mono block">XGBoost</span>
          <span className="text-xs text-gray-600 dark:text-gray-400 uppercase font-mono tracking-wider block">Model Architecture</span>
        </div>
        <div className="p-6 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/10 text-center space-y-1">
          <span className="text-3xl font-black text-rose-500 font-mono block">4.09 ms</span>
          <span className="text-xs text-gray-600 dark:text-gray-400 uppercase font-mono tracking-wider block">P50 Rank Latency</span>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Scoring Engine</h2>
          <p className="text-sm text-gray-600 dark:text-gray-400">How XGBoost calculates the perfect dish.</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-stretch">
          <div className="md:col-span-3 p-6 rounded-2xl bg-gray-50 dark:bg-[#0D0F12] border border-gray-200 dark:border-white/10 font-mono text-sm shadow-xl flex items-center">
            <pre className="text-gray-700 dark:text-gray-300 w-full overflow-x-auto">
<span className="text-rose-400">def</span> <span className="text-amber-300">rank_dish</span>(dish, user_prefs):
    ...
    <span className="text-rose-400">return</span> apply_mmr_diversity(score)
          ...
          <div className="md:col-span-2 space-y-4 flex flex-col justify-center">
            <div className="p-5 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/5 space-y-2">
              <h4 className="font-bold text-gray-900 dark:text-white flex items-center gap-2"><Settings className="w-4 h-4 text-emerald-400"/> Why a weighted sum?</h4>
            ...
            <div className="p-5 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/5 space-y-2">
              <h4 className="font-bold text-gray-900 dark:text-white flex items-center gap-2"><Activity className="w-4 h-4 text-rose-400"/> Normalisation</h4>
              <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Data and Protocol</h2>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/10 space-y-4">
      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">How to evaluate it in two minutes</h2>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-6 rounded-2xl bg-white dark:bg-[#141820] border border-gray-200 dark:border-white/10 space-y-2">
      ...
      <div className="space-y-6 border-t border-gray-200 dark:border-white/10 pt-10">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">Where it falls short</h2>
        </div>
